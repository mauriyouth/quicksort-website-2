                                            ...
                                            {servicesData.map((service, serviceIndex) => {
                                                ...
                                                return (
                                                    <Link
                                                        key={serviceIndex}
                                                        to={service.href}
                                                        className="group flex items-start gap-3 p-3 rounded-lg hover:bg-surface-sunken transition-colors"
                                                    >
                                                        <div className={`flex-shrink-0 w-10 h-10 rounded-lg flex items-center justify-center ${
                                                            service.iconSrc
                                                                ? ""
                                                                : `transition-colors ${service.iconBgClass} group-hover:!bg-signal`
                                                        }`}>
                                                            {service.iconSrc ? (
                                                                <img
                                                                    src={service.iconSrc}
                                                                ...
                                                                <Icon className="w-5 h-5 transition-colors text-on-fill group-hover:!text-signal-fg" />
                                                            ) : null}
                                                        </div>
