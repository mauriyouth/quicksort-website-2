      ...
      <div className="flex flex-col items-center justify-center gap-12 px-8 py-24 w-full bg-gradient-to-b from-[#0a0a0a] to-[#101010]">
        <div className="flex flex-col max-w-screen-xl items-center gap-12 w-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-4xl">
            ...
            <div className="group relative flex flex-col items-center gap-4 p-8 rounded-2xl bg-[#000000] border border-[#1f242f] hover:border-[#ccff00]/40 transition-all duration-300">
            ...
            {/* Value 2: Excellence */}
            <div className="group relative flex flex-col items-center gap-4 p-8 rounded-2xl bg-[#000000] border border-[#1f242f] hover:border-[#a78bfa]/40 transition-all duration-300">
            ...
            <div className="group relative flex flex-col items-center gap-4 p-8 rounded-2xl bg-[#000000] border border-[#1f242f] hover:border-[#f472b6]/40 transition-all duration-300">
