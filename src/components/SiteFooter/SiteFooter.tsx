...
const decorativeRectangles = [
    { top: "top-[-25px]", borderColor: "border-ink" },
    { top: "top-[5px]", borderColor: "border-signal" },
    { top: "top-[23px]", borderColor: "border-ink" },
    { top: "top-[49px]", borderColor: "border-ink" },
    { top: "top-[85px]", borderColor: "border-ink" },
];
...
export const SiteFooter = ({
    ...
    return (
        <footer
            className={`flex flex-col items-center w-full bg-surface ${isHomepage
                ...
                >
                    ...
                    >
                        ...
                        <div className="absolute top-px left-0 w-[29px] h-[27px]">
                            ...
                            <div className="top-4 left-[19px] w-[9px] h-[9px] rounded-[4.39px] absolute bg-ink" />
                        </div>
                    </Link>
                    ...
                    >
                        <h2
                            className={`font-display-sm-semibold font-[number:var(--display-sm-semibold-font-weight)] text-ink tracking-[var(--display-sm-semibold-letter-spacing)] [font-style:var(--display-sm-semibold-font-style)] ${isHomepage
            ...
            >
                <div
                    className={`flex items-center justify-between self-stretch w-full ${isHomepage
                        ...
                        : "flex-wrap gap-[24px_32px] pt-8 pb-0 px-0 border-t [border-top-style:solid] border-line"
                        }`}
                >
                    {/* Copyright */}
                    <p
                        className={`w-fit mt-[-1.00px] font-text-md-regular font-[number:var(--text-md-regular-font-weight)] text-ink-muted tracking-[var(--text-md-regular-letter-spacing)] leading-[var(--text-md-regular-line-height)] whitespace-nowrap [font-style:var(--text-md-regular-font-style)] ${isHomepage
