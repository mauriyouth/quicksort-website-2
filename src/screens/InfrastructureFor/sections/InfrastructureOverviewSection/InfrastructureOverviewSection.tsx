        ...
        <div className="flex flex-wrap items-center gap-[130px] max-w-screen-xl w-full px-8">
          <div className="flex flex-col items-start gap-12 flex-1 min-w-[300px]">
            <div className="flex flex-col items-start gap-3 w-full">
              <p className="mt-[-1.00px] font-text-md-semibold font-[number:var(--text-md-semibold-font-weight)] text-cat-green text-[length:var(--text-md-semibold-font-size)] tracking-[var(--text-md-semibold-letter-spacing)] leading-[var(--text-md-semibold-line-height)] [font-style:var(--text-md-semibold-font-style)]">
