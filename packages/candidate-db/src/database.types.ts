import type { BlogRecord, BlogInsert } from "./blog";
export type Json =
  | string
  | number
  | boolean
...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      kanban_cards: { Row: { id: string; board_id: string; column_id: string; title: string; description: string; due_at: string | null; created_by: string; creator_name: string; created_at: string }; Insert: { board_id: string; column_id: string; title: string; description?: string; due_at?: string | null }; Update: { column_id?: string; title?: string; description?: string; due_at?: string | null }; Relationships: [] };
      ...
      admin_access_audit: {
        ...
        Relationships: [
          {
            foreignKeyName: "admin_access_audit_actor_id_fkey"
            columns: ["actor_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "admin_access_audit_target_id_fkey"
            columns: ["target_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      admin_access_requests: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "admin_access_requests_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: true
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      contract_signatures: {
        ...
        Relationships: [
          {
            foreignKeyName: "contract_signatures_candidate_id_fkey"
            columns: ["candidate_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      portal_owners: {
        ...
        Relationships: [
          {
            foreignKeyName: "portal_owners_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: true
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      tool_requests: {
        ...
        Relationships: [
          {
            foreignKeyName: "tool_requests_candidate_id_fkey"
            columns: ["candidate_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
