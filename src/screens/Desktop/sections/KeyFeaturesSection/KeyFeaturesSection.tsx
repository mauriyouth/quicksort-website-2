        ...
        >
          <div className="flex flex-col items-start gap-5 w-full">
            <div className="relative w-14 h-[52px] shrink-0">
              <div className="absolute top-0 left-0 w-[51px] h-[51px] bg-ink rounded-[25.33px]" />
              <div className="absolute top-[18px] left-[30px] w-[17px] h-[34px] bg-surface rounded-[34.62px] rotate-[-47.64deg]" />
