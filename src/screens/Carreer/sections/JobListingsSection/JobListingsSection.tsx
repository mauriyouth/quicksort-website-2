...
export const JobListingsSection = (): JSX.Element => {
  return (
    <section className="flex flex-col items-center w-full">
          ...
          <div className="flex flex-col min-w-[480px] items-start gap-8 flex-1 grow">
            <div className="flex flex-col max-w-screen-md items-start gap-5 w-full">
              ...
              <div className="flex flex-col items-start gap-5">
                ...
                <p className="font-text-xl-regular font-[number:var(--text-xl-regular-font-weight)] text-ink-muted text-[length:var(--text-xl-regular-font-size)] tracking-[var(--text-xl-regular-letter-spacing)] leading-[var(--text-xl-regular-line-height)] [font-style:var(--text-xl-regular-font-style)]">
                  Our philosophy is grounded in a simple equation: <span className="text-signal-text font-semibold">Human + AI = Compound Value</span>. We believe the future isn&apos;t about AI replacing people, but about collaborative systems that make teams more effective, decisions more informed, and businesses more resilient.
                </p>

                <div className="mt-4">
                  <h4 className="font-text-md-semibold font-[number:var(--text-md-semibold-font-weight)] text-ink text-[length:var(--text-md-semibold-font-size)] tracking-[var(--text-md-semibold-letter-spacing)] leading-[var(--text-md-semibold-line-height)] [font-style:var(--text-md-semibold-font-style)] mb-3">
                    What we do
                  </h4>
                  <p className="font-text-md-regular font-[number:var(--text-md-regular-font-weight)] text-ink-muted text-[length:var(--text-md-regular-font-size)] tracking-[var(--text-md-regular-letter-spacing)] leading-[var(--text-md-regular-line-height)] [font-style:var(--text-md-regular-font-style)] mb-3">
      ...
      {/* Core Values Section */}
      <div className="flex flex-col items-center justify-center gap-12 px-8 py-24 w-full bg-gradient-to-b from-surface to-surface-raised">
        <div className="flex flex-col max-w-screen-xl items-center gap-12 w-full">
          <div className="flex flex-col items-center gap-4 w-full">
            <p className="font-text-md-semibold font-[number:var(--text-md-semibold-font-weight)] text-signal-text text-[length:var(--text-md-semibold-font-size)] tracking-[var(--text-md-semibold-letter-spacing)] leading-[var(--text-md-semibold-line-height)] [font-style:var(--text-md-semibold-font-style)]">
              Who you'll work with
            </p>
            <h2 className="text-[length:var(--display-md-semibold-font-size)] text-center tracking-[var(--display-md-semibold-letter-spacing)] leading-[var(--display-md-semibold-line-height)] font-display-md-semibold font-[number:var(--display-md-semibold-font-weight)] text-ink [font-style:var(--display-md-semibold-font-style)]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-4xl">
            ...
            <div className="group relative flex flex-col items-center gap-4 p-8 rounded-2xl bg-surface border border-line hover:border-signal/40 transition-all duration-300">
              <div className="w-16 h-16 rounded-full bg-gradient-to-br from-signal/20 to-signal/5 flex items-center justify-center">
                <svg className="w-8 h-8 text-signal-text" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                </svg>
              </div>
              <h3 className="font-text-xl-semibold text-ink text-xl font-semibold text-center">
                Bias for action
              </h3>
            ...
            {/* Value 2: Excellence */}
            <div className="group relative flex flex-col items-center gap-4 p-8 rounded-2xl bg-surface border border-line hover:border-cat-violet-soft/40 transition-all duration-300">
              <div className="w-16 h-16 rounded-full bg-gradient-to-br from-cat-violet-soft/20 to-cat-violet-soft/5 flex items-center justify-center">
                <svg className="w-8 h-8 text-cat-violet-soft" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="group relative flex flex-col items-center gap-4 p-8 rounded-2xl bg-surface border border-line hover:border-cat-pink-soft/40 transition-all duration-300">
              <div className="w-16 h-16 rounded-full bg-gradient-to-br from-cat-pink-soft/20 to-cat-pink-soft/5 flex items-center justify-center">
        ...
        <div className="flex flex-col max-w-screen-xl items-start gap-8 px-8 py-0 w-full">
          <div className="flex flex-col items-center gap-8 w-full">
            <div className="gap-5 flex flex-col max-w-screen-md items-center w-full">
              <h2 className="mt-[-1.00px] text-[length:var(--display-md-semibold-font-size)] text-center tracking-[var(--display-md-semibold-letter-spacing)] leading-[var(--display-md-semibold-line-height)] font-display-md-semibold font-[number:var(--display-md-semibold-font-weight)] text-ink [font-style:var(--display-md-semibold-font-style)]">
                We unite world-class talent to push boundaries and build
                what&apos;s next.
              </h2>

              <p className="font-text-xl-regular font-[number:var(--text-xl-regular-font-weight)] text-ink-muted text-[length:var(--text-xl-regular-font-size)] text-center tracking-[var(--text-xl-regular-letter-spacing)] leading-[var(--text-xl-regular-line-height)] [font-style:var(--text-xl-regular-font-style)]">
                ...
                <CardContent className="flex flex-col items-start gap-4 w-full p-0">
                  <div className="items-start gap-4 w-full flex">
                    ...
                    <Link to={`/career/${job.slug}`} className="gap-1.5 inline-flex items-center justify-center cursor-pointer hover:opacity-80 transition-opacity">
                      <span className="mt-[-1.00px] font-text-sm-semibold font-[number:var(--text-sm-semibold-font-weight)] text-ink-2 text-[length:var(--text-sm-semibold-font-size)] tracking-[var(--text-sm-semibold-letter-spacing)] leading-[var(--text-sm-semibold-line-height)] whitespace-nowrap [font-style:var(--text-sm-semibold-font-style)]">
                        View job
                      </span>
