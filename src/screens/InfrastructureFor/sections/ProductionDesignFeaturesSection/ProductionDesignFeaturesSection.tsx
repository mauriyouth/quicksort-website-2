  ...
  return (
    <section className="flex flex-col items-center gap-16 px-0 py-24 w-full bg-surface">
      ...
      <div className="flex flex-col items-start gap-4 max-w-screen-xl px-8 py-0 w-full">
        <h2 className="mt-[-1.00px] font-text-xl-semibold font-[number:var(--text-xl-semibold-font-weight)] text-ink text-[length:var(--text-xl-semibold-font-size)] tracking-[var(--text-xl-semibold-letter-spacing)] leading-[var(--text-xl-semibold-line-height)] [font-style:var(--text-xl-semibold-font-style)]">
