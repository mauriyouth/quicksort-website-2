    ...
    <footer className="flex flex-col items-center gap-16 pt-16 pb-12 px-0 relative w-full bg-[#141414]">
      ...
      <div className="flex max-w-screen-xl items-center justify-center gap-8 px-8 py-0 relative w-full z-[1]">
        <div className="flex flex-col items-start justify-center gap-12 relative flex-1">
          ...
          <div className="max-w-screen-md justify-center gap-4 w-full flex flex-col items-start relative">
            <h2 className="mt-[-1.00px] font-display-sm-semibold font-[number:var(--display-sm-semibold-font-weight)] text-[length:var(--display-sm-semibold-font-size)] tracking-[var(--display-sm-semibold-letter-spacing)] leading-[var(--display-sm-semibold-line-height)] relative self-stretch text-[#f5f5f6] [font-style:var(--display-sm-semibold-font-style)]">
          ...
          <div className="inline-flex items-start gap-3 relative">
            <Button className="gap-2.5 px-[22px] py-4 bg-[#ccff00] hover:bg-[#ccff00]/90 rounded-lg border border-solid border-black shadow-shadows-shadow-xs text-black font-text-lg-semibold font-[number:var(--text-lg-semibold-font-weight)] text-[length:var(--text-lg-semibold-font-size)] tracking-[var(--text-lg-semibold-letter-spacing)] leading-[var(--text-lg-semibold-line-height)] [font-style:var(--text-lg-semibold-font-style)]">
              Get in touch
            </Button>
          </div>
        </div>

        <div className="relative w-[309.55px] h-[228.48px] rotate-[-16.24deg]">
              ...
              >
                {info.isLink ? (
                  <a
                    ...
                    target="_blank"
                    className="leading-[var(--text-md-regular-line-height)] underline font-text-md-regular [font-style:var(--text-md-regular-font-style)] font-[number:var(--text-md-regular-font-weight)] tracking-[var(--text-md-regular-letter-spacing)] text-[length:var(--text-md-regular-font-size)] hover:text-white transition-colors"
                  >
                    {info.label}
                  </a>
                ) : (
                  <span className="font-text-md-regular font-[number:var(--text-md-regular-font-weight)] text-[length:var(--text-md-regular-font-size)] tracking-[var(--text-md-regular-letter-spacing)] leading-[var(--text-md-regular-line-height)] whitespace-nowrap [font-style:var(--text-md-regular-font-style)]">
                    {info.label}
                  </span>
                )}
              </div>
